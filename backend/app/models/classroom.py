...
class Classroom(Base):
    ...
    class_teacher_id: Mapped[int] = mapped_column(ForeignKey("users.id"), nullable=False, index=True)
    name: Mapped[str] = mapped_column(String(200), nullable=False)
    code: Mapped[str] = mapped_column(String(50), nullable=False)
    join_code: Mapped[str] = mapped_column(String(5), unique=True, index=True, nullable=False)
...
class ClassroomTeacher(Base):
    ...
    __table_args__ = (
        UniqueConstraint("classroom_id", "teacher_id", "subject_label", name="uq_classroom_teacher_subject"),
    )
    ...
    subject_label: Mapped[str] = mapped_column(String(120), nullable=False, default="GENERAL")
    is_active: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
