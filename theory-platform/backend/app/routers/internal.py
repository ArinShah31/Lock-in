...
from app.models import TheoryTest, TestAssignment, TestSession, User, UserRole
...
def _coding_points_for_student(db: Session, student_id: int) -> int:
    ...
    for assignment in assignments:
        by_test[assignment.theory_test_id].append(assignment)
...
def streak_events(
    ...
    for assignment in assignments:
        test = db.query(TheoryTest).filter(TheoryTest.id == assignment.theory_test_id).first()
