"""Bloom taxonomy helpers and default rubrics for theory questions."""
...
DEFAULT_RUBRIC: list[dict] = [
    {
        "name": "Accuracy",
        "description": "Facts, definitions, and claims are correct.",
        "weight": 40,
        "max_points": 100,
    },
    {
        "name": "Completeness",
        "description": "All parts of the question are addressed.",
        "weight": 25,
        "max_points": 100,
    },
    {
        "name": "Reasoning",
        "description": "Arguments are logical, step-by-step, and well supported.",
        "weight": 20,
        "max_points": 100,
    },
    {
        "name": "Terminology",
        "description": "Uses appropriate subject vocabulary and examples.",
        "weight": 15,
        "max_points": 100,
    },
]
