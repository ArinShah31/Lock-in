...
class Question(Base):
    ...
    subject: Mapped[SubjectArea] = mapped_column(SqlEnum(SubjectArea), nullable=False, index=True)
...
class TheoryTest(Base):
    __tablename__ = "theory_tests"
    ...
    questions = relationship("TheoryTestQuestion", back_populates="theory_test", cascade="all, delete-orphan")
    assignments = relationship("TestAssignment", back_populates="theory_test", cascade="all, delete-orphan")


class TheoryTestQuestion(Base):
    __tablename__ = "theory_test_questions"
    __table_args__ = (UniqueConstraint("theory_test_id", "order_index", name="uq_theory_test_order"),)

    id: Mapped[int] = mapped_column(primary_key=True, index=True)
    theory_test_id: Mapped[int] = mapped_column(ForeignKey("theory_tests.id"), nullable=False, index=True)
    ...
    theory_test = relationship("TheoryTest", back_populates="questions")
    question = relationship("Question")


class TestAssignment(Base):
    __tablename__ = "test_assignments"
    __table_args__ = (UniqueConstraint("theory_test_id", "student_id", name="uq_theory_test_student"),)
    ...
    theory_test = relationship("TheoryTest", back_populates="assignments")
...
class TestSession(Base):
    ...
    drafts = relationship("AnswerDraft", back_populates="session", cascade="all, delete-orphan")
    submissions = relationship("AnswerSubmission", back_populates="session", cascade="all, delete-orphan")
...
class AnswerSubmission(Base):
    ...
    subject: Mapped[SubjectArea] = mapped_column(SqlEnum(SubjectArea), nullable=False)
...
class EvalRun(Base):
    ...
    submission_id: Mapped[int] = mapped_column(
        ForeignKey("answer_submissions.id"), unique=True, nullable=False, index=True
    )
    ...
    submission = relationship("AnswerSubmission", back_populates="eval_run")
